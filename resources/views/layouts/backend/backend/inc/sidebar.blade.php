            ...
            <ul>
                ...
                <li class="submenu">
                    <a href="#"><i class="fa fa-medkit" aria-hidden="true"></i>
                        <span> Maganize </span> <span class="menu-arrow"></span></a>
                    <ul style="display: none;">
                        <li><a href="{{ route('admin.add.medicine') }}">Add Magazine</a></li>
                        <li><a href="{{ route('admin.medicine.list') }}">Maganize List</a></li>
                    </ul>
                </li>
<!-- 
                <li class="submenu">
